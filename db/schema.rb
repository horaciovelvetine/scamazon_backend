...
ActiveRecord::Schema.define(version: 2021_11_04_213200) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["search_id"], name: "index_categories_on_search_id"
  end
  ...
  create_table "gift_cards", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["redeem_code"], name: "index_gift_cards_on_redeem_code", unique: true
  ...
  create_table "styles", force: :cascade do |t|
    ...
    t.index ["model_num"], name: "index_styles_on_model_num"
  end
  ...
  add_foreign_key "categories", "searches"
