...
ActiveRecord::Schema.define(version: 2021_11_06_173846) do
  ...
  create_table "returns", force: :cascade do |t|
    ...
    t.index ["status_id"], name: "index_returns_on_status_id"
  ...
  create_table "styles", force: :cascade do |t|
    ...
    t.index ["return_id"], name: "index_styles_on_return_id"
  ...
  add_foreign_key "returns", "statuses"
  ...
  add_foreign_key "styles", "returns"
