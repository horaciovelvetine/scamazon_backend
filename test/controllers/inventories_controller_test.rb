...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { description: @inventory.description, store_id: @inventory.store_id } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { description: @inventory.description, store_id: @inventory.store_id } }
